...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_raw_candidates_airtable_record_id")
        ),
    )
    op.create_table(
        "raw_jobs",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["raw_candidates.id"],
            name=op.f("fk_candidate_vectors_candidate_id_raw_candidates"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["job_id"],
            ["raw_jobs.id"],
            name=op.f("fk_job_vectors_job_id_raw_jobs"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "seniority_level",
            sa.Enum(
                "JUNIOR", "MID", "SENIOR", "LEAD", "PRINCIPAL", "EXECUTIVE", name="seniority_enum"
            ),
            nullable=True,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["raw_candidate_id"],
            ["raw_candidates.id"],
            name=op.f("fk_normalized_candidates_raw_candidate_id_raw_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_normalized_candidates")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_normalized_candidates_airtable_record_id")
        ),
    )
    op.create_table(
        "normalized_jobs",
        ...
        sa.Column(
            "company_stage",
            sa.Enum("STARTUP", "SCALEUP", "ENTERPRISE", "DAO", name="company_stage_enum"),
            nullable=True,
        ),
        ...
        sa.Column(
            "location_type",
            sa.Enum("REMOTE", "HYBRID", "ONSITE", name="location_type_enum"),
            nullable=True,
        ),
        ...
        sa.Column(
            "employment_type",
            sa.Enum("FULL_TIME", "PART_TIME", "CONTRACT", name="employment_type_enum"),
            nullable=True,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "PAUSED", "FILLED", "CLOSED", name="job_status_enum"),
            nullable=False,
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_normalized_jobs_ck_job_autonomy_range"),
        ),
        sa.CheckConstraint(
            "min_communication_score IS NULL OR (min_communication_score >= 1 AND min_communication_score <= 5)",
            name=op.f("ck_normalized_jobs_ck_job_communication_range"),
        ),
        sa.CheckConstraint(
            "min_growth_trajectory_score IS NULL OR (min_growth_trajectory_score >= 1 AND min_growth_trajectory_score <= 5)",
            name=op.f("ck_normalized_jobs_ck_job_growth_trajectory_range"),
        ),
        sa.CheckConstraint(
            "min_leadership_score IS NULL OR (min_leadership_score >= 1 AND min_leadership_score <= 5)",
            name=op.f("ck_normalized_jobs_ck_job_leadership_range"),
        ),
        sa.CheckConstraint(
            "min_technical_depth_score IS NULL OR (min_technical_depth_score >= 1 AND min_technical_depth_score <= 5)",
            name=op.f("ck_normalized_jobs_ck_job_technical_depth_range"),
        ),
        sa.CheckConstraint(
            "priority >= 1 AND priority <= 4", name=op.f("ck_normalized_jobs_ck_job_priority_range")
        ),
        sa.ForeignKeyConstraint(
            ["raw_job_id"],
            ["raw_jobs.id"],
            name=op.f("fk_normalized_jobs_raw_job_id_raw_jobs"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_normalized_jobs")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_normalized_jobs_airtable_record_id")
        ),
    )
    op.create_table(
        "skill_aliases",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_candidate_attributes_ck_autonomy_range"),
        ),
        sa.CheckConstraint(
            "communication_score IS NULL OR (communication_score >= 1 AND communication_score <= 5)",
            name=op.f("ck_candidate_attributes_ck_communication_range"),
        ),
        sa.CheckConstraint(
            "growth_trajectory_score IS NULL OR (growth_trajectory_score >= 1 AND growth_trajectory_score <= 5)",
            name=op.f("ck_candidate_attributes_ck_growth_trajectory_range"),
        ),
        sa.CheckConstraint(
            "leadership_score IS NULL OR (leadership_score >= 1 AND leadership_score <= 5)",
            name=op.f("ck_candidate_attributes_ck_leadership_range"),
        ),
        sa.CheckConstraint(
            "technical_depth_score IS NULL OR (technical_depth_score >= 1 AND technical_depth_score <= 5)",
            name=op.f("ck_candidate_attributes_ck_technical_depth_range"),
        ),
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_attributes_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_attributes")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_attributes_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_experiences_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_experiences")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_experiences_airtable_record_id")
        ),
    )
    op.create_table(
        "candidate_github_metrics",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("airtable_record_id", sa.String(length=255), nullable=True),
        sa.Column("candidate_id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_github_metrics_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_github_metrics")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_github_metrics_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_linkedin_metrics_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_linkedin_metrics")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_linkedin_metrics_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_projects_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_projects")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_projects_airtable_record_id")
        ),
    )
    op.create_table(
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_candidate_role_fitness_ck_fitness_range"),
        ),
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_role_fitness_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_role_fitness")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_role_fitness_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.Column("rating_model", sa.String(length=50), nullable=True),
        sa.CheckConstraint(
            "rating >= 1 AND rating <= 5", name=op.f("ck_candidate_skills_ck_rating_range")
        ),
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_skills_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["skill_id"],
            ["skills.id"],
            name=op.f("fk_candidate_skills_skill_id_skills"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_skills")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_skills_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_candidate_twitter_metrics_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_candidate_twitter_metrics")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_candidate_twitter_metrics_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "requirement_type",
            sa.Enum("MUST_HAVE", "NICE_TO_HAVE", name="requirement_type_enum"),
            nullable=False,
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("ck_job_required_skills_ck_min_years_positive"),
        ),
        sa.ForeignKeyConstraint(
            ["job_id"],
            ["normalized_jobs.id"],
            name=op.f("fk_job_required_skills_job_id_normalized_jobs"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["skill_id"],
            ["skills.id"],
            name=op.f("fk_job_required_skills_skill_id_skills"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_job_required_skills")),
        sa.UniqueConstraint(
            "airtable_record_id", name=op.f("uq_job_required_skills_airtable_record_id")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "MATCHED", "REVIEWED", "CONTACTED", "REJECTED", "HIRED", name="match_status_enum"
            ),
            nullable=False,
        ),
        ...
        sa.Column("algorithm_version", sa.String(length=50), nullable=True),
        sa.CheckConstraint(
            "match_score >= 0 AND match_score <= 1", name=op.f("ck_matches_ck_match_score_range")
        ),
        sa.ForeignKeyConstraint(
            ["candidate_id"],
            ["normalized_candidates.id"],
            name=op.f("fk_matches_candidate_id_normalized_candidates"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["job_id"],
            ["normalized_jobs.id"],
            name=op.f("fk_matches_job_id_normalized_jobs"),
            ondelete="CASCADE",
        ),
